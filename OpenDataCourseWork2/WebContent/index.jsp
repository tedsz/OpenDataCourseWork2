...
<section class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--full-height mbr-section--bg-adapted mbr-parallax-background mbr-after-navbar" id="header1-1" style="background-image: url(assets/images/court-1920x1200-78.jpg);">
            ...
            <div class="mbr-box mbr-box--stretched"><div class="mbr-box__magnet mbr-box__magnet--center-center">
                <div class="row"><div class=" col-sm-8 col-sm-offset-2">
                    <div class="mbr-hero animated fadeInUp">
                        <h1 class="mbr-hero__text">Your personal Prophet</h1>
                        <p class="mbr-hero__subtext">This is the website of football data visualization &amp; result prediction.</p>
                    </div>
                    <div class="mbr-buttons btn-inverse mbr-buttons--center"> <a class="mbr-buttons__btn btn btn-lg btn-default animated fadeInUp delay" href="index.html#msg-box1-29">FIND MORE</a></div>
                </div></div>
            </div></div>
        </div>
        <div class="mbr-arrow mbr-arrow--floating text-center">
            <div class="mbr-section__container container">
                <a class="mbr-arrow__link" href="#msg-box1-29"><i class="glyphicon glyphicon-menu-down"></i></a>
            </div>
        </div>
    </div>
</section>

<section class="mbr-section mbr-section--relative mbr-section--short-paddings" id="msg-box1-29" style="background-color: rgb(60, 60, 60);">
    ...
    <div class="row" style="padding:40px 0;background-color:rgba(0, 35, 72, 0.66);border-radius:30px;box-shadow: 5px 5px 25px black;max-width:1000px;min-width:405px;margin:0 auto;">
        <div class="col-md-6" >
            <div id="allteams" style="width:100%;margin:0 auto;text-align:center;">
	            ...
	            <h4 style="color:#E2FF00;padding-right:40px;">amount of matches</h4>
            </div>
        </div>
        <div class="col-md-6">
            <div id="pie_totalF" style="width:100%;margin:0 auto;text-align:center;">
            	<h2 style="color:white;" id="pie_totalFtitle">FULL TIME ODDS</h2>
            	<h4 style="color:#E2FF00;padding-right:200px;">H:HomeWin</h4>
            	<h4 style="color:#E2FF00;padding-right:233px;">D:Draw</h4>
            	<h4 style="color:#E2FF00;padding-right:208px;">A:AwayWin</h4>
            </div>
            <br/>
            <div id="pie_totalH" style="width:100%;margin:0 auto;text-align:center;">
...
<section class="mbr-section mbr-section--relative mbr-section--short-paddings" id="msg-box1-23" style="background-color: rgb(60, 60, 60);">
...
<section class="mbr-section mbr-section--relative mbr-section--fixed-size mbr-parallax-background" id="features1-11" style="background-image: url(assets/images/football-1366x768-41.jpg);">
